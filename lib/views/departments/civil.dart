import 'package:abhiyanth/providers/departments/civil_provider.dart';
...
class Civil extends ConsumerStatefulWidget {
  const Civil({super.key});

  @override
  ConsumerState<Civil> createState() => _CivilState();
}

class _CivilState extends ConsumerState<Civil> {
  @override
  void initState() {
    super.initState();
    // Fetch tech events when the page loads
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(civilEventsProvider.notifier).fetchTechEvents();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final techEventsState = ref.watch(civilEventsProvider);
