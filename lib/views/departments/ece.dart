import 'package:abhiyanth/providers/departments/ece_provider.dart';
...
class ECE extends ConsumerStatefulWidget {
  const ECE({Key? key}) : super(key: key);

  @override
  ConsumerState<ECE> createState() => _ECEState();
}

class _ECEState extends ConsumerState<ECE> {
  @override
  void initState() {
    super.initState();
    // Fetch tech events when the page loads
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(eceEventsProvider.notifier).fetchTechEvents();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final techEventsState = ref.watch(eceEventsProvider);
