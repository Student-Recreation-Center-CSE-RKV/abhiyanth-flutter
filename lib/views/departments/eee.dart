import 'package:abhiyanth/providers/departments/eee_provider.dart';
...
class EEE extends ConsumerStatefulWidget {
  const EEE({Key? key}) : super(key: key);

  @override
  ConsumerState<EEE> createState() => _EEEState();
}

class _EEEState extends ConsumerState<EEE> {
  @override
  void initState() {
    super.initState();
    // Fetch tech events when the page loads
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(eeeEventsProvider.notifier).fetchTechEvents();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final techEventsState = ref.watch(eeeEventsProvider);
