import 'package:abhiyanth/providers/departments/chemical_provider.dart';
...
class Chemical extends ConsumerStatefulWidget {
  const Chemical({Key? key}) : super(key: key);

  @override
  ConsumerState<Chemical> createState() => _ChemicalState();
}

class _ChemicalState extends ConsumerState<Chemical> {
  @override
  void initState() {
    super.initState();
    // Fetch tech events when the page loads
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(chemicalEventsProvider.notifier).fetchTechEvents();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final techEventsState = ref.watch(chemicalEventsProvider);
