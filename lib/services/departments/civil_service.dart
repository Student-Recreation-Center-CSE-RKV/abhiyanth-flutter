...
class CivilTechService {
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;

  Future<Map<String, List<Map<String, dynamic>>>> getTechEvents() async {
    try {
      final querySnapshot = await _firestore.collection('TechEvents_Civil').get();
      ...
      for (var doc in querySnapshot.docs) {
        ...
        if (eventDate != null) {
          final event = {
            ...
            'title' :eventData['title'] ?? 'Civil tech',
          };
      ...
      print('Error fetching TechEvents_Civil: $e');
