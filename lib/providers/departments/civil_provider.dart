import 'package:abhiyanth/services/departments/civil_service.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

/// Service provider for TechEventsService
final techEventsServiceProvider = Provider<CivilTechService>((ref) {
  return CivilTechService();
});
...
class TechEventsNotifier
  ...
  final CivilTechService _service;
...
final civilEventsProvider = StateNotifierProvider<TechEventsNotifier,
