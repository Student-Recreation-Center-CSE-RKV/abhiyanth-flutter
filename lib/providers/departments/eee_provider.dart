import 'package:abhiyanth/services/departments/eee_service.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

/// Service provider for TechEventsService
final techEventsServiceProvider = Provider<EeeTechService>((ref) {
  return EeeTechService();
});
...
final eeeEventsProvider = StateNotifierProvider<
    TechEventsNotifier,
