import 'package:abhiyanth/services/departments/cse_service.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

/// Service provider for TechEventsService
final techEventsServiceProvider = Provider<CseTechService>((ref) {
  return CseTechService();
});
...
final cseEventsProvider = StateNotifierProvider<
    TechEventsNotifier,
